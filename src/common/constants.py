...
MAIN_WINDOW_MENU_DOCUMENTATION_TITLE: str = "Documentation"
...
PLOTTER_HEIGHT_INCHES: float = 7.6
...
MAIN_WINDOW_TAB_GENERIC_BUTTON_WIDTH: int = 390
MAIN_WINDOW_TAB_GENERIC_BUTTON_HEIGHT: int = 65
